from configs.ocp._base_.agents import mappo_benchmark_agent_copy
from configs.ocp._base_.envs import mappo_benchmark_env_copy
from configs.ocp._base_.experts import gail_expert  # noqa: F401
from configs.ocp._base_.params_benchmark_copy import AGENT_NUM, BENCHMARK_NAME, MANUAL
...
if agent_type == "MAPPO_PointNet2":
    env = mappo_benchmark_env_copy
    agent_cfg = mappo_benchmark_agent_copy
