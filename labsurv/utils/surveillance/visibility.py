...
def check_obstacle_dda(cam_pos: Tensor, targets: Tensor, grid: Tensor) -> Tensor:
    """
...
def check_obstacle_precise(
    ...
    ## CAUTION:
        ...
        This method is time-consuming and is deprecated.
...
def if_need_obstacle_check(
    ...
    ## Description:
        ...
        This method generates auxiliary list to speedup `check_obstacle_precise()`.
